...
class TaskResourceIT {
    ...
    private static final Integer DEFAULT_STREAK = 1;
    private static final Integer UPDATED_STREAK = 2;

    private static final Integer DEFAULT_TARGET_STREAK = 1;
    private static final Integer UPDATED_TARGET_STREAK = 2;
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task()
            ...
            .targetStreak(UPDATED_TARGET_STREAK);
        return task;
    }
    ...
    void createTask() throws Exception {
        ...
        assertThat(testTask.getStreak()).isEqualTo(DEFAULT_STREAK);
        assertThat(testTask.getTargetStreak()).isEqualTo(DEFAULT_TARGET_STREAK);
    }
    ...
    @Test
    @Transactional
    void checkStreakIsRequired() throws Exception {
        int databaseSizeBeforeTest = taskRepository.findAll().size();
        // set the field null
        task.setStreak(null);
    ...
    @Test
    @Transactional
    void checkTargetStreakIsRequired() throws Exception {
        int databaseSizeBeforeTest = taskRepository.findAll().size();
        // set the field null
        task.setTargetStreak(null);
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].streak").value(hasItem(DEFAULT_STREAK)))
            .andExpect(jsonPath("$.[*].targetStreak").value(hasItem(DEFAULT_TARGET_STREAK)));
    }
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.streak").value(DEFAULT_STREAK))
            .andExpect(jsonPath("$.targetStreak").value(DEFAULT_TARGET_STREAK));
    }
    ...
    void putExistingTask() throws Exception {
        ...
        assertThat(testTask.getStreak()).isEqualTo(UPDATED_STREAK);
        assertThat(testTask.getTargetStreak()).isEqualTo(UPDATED_TARGET_STREAK);
    }
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).streak(UPDATED_STREAK);
